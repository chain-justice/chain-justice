...
import { WeightedVoteOption } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "chain-justice-chain-justice-client-ts/cosmos.gov.v1beta1/types"
