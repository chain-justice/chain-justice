...
import (
	...
	"github.com/chain-justice/chain-justice/docs"
...
func New(
	...
	*/
	...
	app.ChainjusticeKeeper = *chainjusticemodulekeeper.NewKeeper(
		appCodec,
		keys[chainjusticemoduletypes.StoreKey],
		keys[chainjusticemoduletypes.MemStoreKey],
		app.GetSubspace(chainjusticemoduletypes.ModuleName),
	)
