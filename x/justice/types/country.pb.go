...
type Country struct {
	...
	Nmembers string `protobuf:"bytes,4,opt,name=nmembers,proto3" json:"nmembers,omitempty"`
}
...
func (m *Country) GetNmembers() string {
	if m != nil {
		return m.Nmembers
	}
	return ""
...
var fileDescriptor_6b5dbe21041da351 = []byte{
	...
	0x26, 0x17, 0xbb, 0x33, 0x44, 0x8f, 0x90, 0x08, 0x17, 0x6b, 0x66, 0x5e, 0x4a, 0x6a, 0x85, 0x04,
	...
	0x24, 0x98, 0xc1, 0xc2, 0x60, 0xb6, 0x90, 0x14, 0x17, 0x47, 0x5e, 0x6e, 0x6a, 0x6e, 0x52, 0x6a,
	0x51, 0xb1, 0x04, 0x0b, 0x58, 0x1c, 0xce, 0x77, 0x0a, 0x38, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23,
	...
	0xb0, 0x2b, 0x75, 0xe1, 0xfe, 0x41, 0xe1, 0x55, 0xe8, 0xc3, 0x58, 0x25, 0x95, 0x05, 0xa9, 0xc5,
	0x49, 0x6c, 0x60, 0x6f, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x0f, 0xbd, 0x58, 0x27, 0xff,
	0x00, 0x00, 0x00,
}
...
func (m *Country) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Nmembers) > 0 {
		i -= len(m.Nmembers)
		copy(dAtA[i:], m.Nmembers)
		i = encodeVarintCountry(dAtA, i, uint64(len(m.Nmembers)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Food) > 0 {
...
func (m *Country) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Nmembers", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Nmembers = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
