...
const (
	...
	opWeightMsgFallCountry = "op_weight_msg_fall_country"
	// TODO: Determine the simulation weight value
	defaultWeightMsgFallCountry int = 100
	...
	opWeightMsgLeaveCountry = "op_weight_msg_leave_country"
	// TODO: Determine the simulation weight value
	defaultWeightMsgLeaveCountry int = 100
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	var weightMsgFallCountry int
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgFallCountry, &weightMsgFallCountry, nil,
		func(_ *rand.Rand) {
			weightMsgFallCountry = defaultWeightMsgFallCountry
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgFallCountry,
		justicesimulation.SimulateMsgFallCountry(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	var weightMsgLeaveCountry int
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgLeaveCountry, &weightMsgLeaveCountry, nil,
		func(_ *rand.Rand) {
			weightMsgLeaveCountry = defaultWeightMsgLeaveCountry
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgLeaveCountry,
		justicesimulation.SimulateMsgLeaveCountry(am.accountKeeper, am.bankKeeper, am.keeper),
	))
