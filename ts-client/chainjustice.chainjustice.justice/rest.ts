...
export interface JusticeBelonging {
  index?: string;
  address?: string;
  country?: string;
}
...
export type JusticeMsgBelongContryResponse = object;

export type JusticeMsgFundCountryResponse = object;

export type JusticeMsgInvasionResultResponse = object;

export type JusticeMsgInvasionStartResponse = object;

export type JusticeMsgPrepareResultResponse = object;

export type JusticeMsgPrepareStartResponse = object;
 ...
 */
export interface JusticeQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: JusticeParams;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryBelongingAll
   * @summary Queries a list of Belonging items.
   * @request GET:/chain-justice/chain-justice/justice/belonging
   */
  queryBelongingAll = (
    query?: {
    ...
    this.request<JusticeQueryAllBelongingResponse, RpcStatus>({
      path: `/chain-justice/chain-justice/justice/belonging`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryBelonging
   * @summary Queries a Belonging by index.
   * @request GET:/chain-justice/chain-justice/justice/belonging/{index}
   */
   ...
   * @tags Query
   * @name QueryInvasion
   * @summary Queries a Invasion by index.
   * @request GET:/chain-justice/chain-justice/justice/invasion/{index}
   */
  queryInvasion = (index: string, params: RequestParams = {}) =>
    this.request<JusticeQueryGetInvasionResponse, RpcStatus>({
      path: `/chain-justice/chain-justice/justice/invasion/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/chain-justice/chain-justice/justice/params
   */
   ...
   * @tags Query
   * @name QueryPrepare
   * @summary Queries a Prepare by index.
   * @request GET:/chain-justice/chain-justice/justice/prepare/{index}
   */
  queryPrepare = (index: string, params: RequestParams = {}) =>
    this.request<JusticeQueryGetPrepareResponse, RpcStatus>({
      path: `/chain-justice/chain-justice/justice/prepare/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
